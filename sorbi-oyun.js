...
+'.sbo-halka span{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:.8rem;font-weight:600;color:#F2D3B8;font-variant-numeric:tabular-nums}'
+'.sbo-bilgi{flex:1 1 200px;min-width:0}'
+'.sbo-bilgi p{font-size:.84rem;color:#9BA0AB;font-weight:300;margin:.15rem 0 0;line-height:1.55}'
...
+'.sbo-s .sbo-nd{font-size:.84rem;font-weight:300;color:#9BA0AB;line-height:1.6;margin:.55rem 0 0;max-width:70ch;border-left:2px solid rgba(255,255,255,.14);padding-left:.8rem}'
...
+'.sbo-s .sbo-son{font-size:.86rem;color:#F2D3B8;font-weight:500;margin-top:1rem;padding-top:.8rem;border-top:1px solid rgba(255,255,255,.08)}'
+'.sbo :focus-visible,.sbo-s :focus-visible{outline:2px solid #F2D3B8;outline-offset:2px;border-radius:8px}'
