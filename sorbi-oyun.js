...
var CSS='.sbo{background:rgba(var(--ink-rgb),.032);border:1px solid rgba(var(--ink-rgb),.08);border-radius:16px;padding:1.1rem;margin:1.4rem 0;font-family:Inter,system-ui,sans-serif;color:var(--ink)}'
...
+'.sbo-halka span{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:.8rem;font-weight:600;color:var(--ink);font-variant-numeric:tabular-nums}'
+'.sbo-bilgi{flex:1 1 200px;min-width:0}'
+'.sbo-bilgi p{font-size:.84rem;color:var(--mut);font-weight:300;margin:.15rem 0 0;line-height:1.55}'
+'.sbo-cubuk{height:6px;border-radius:99px;background:rgba(var(--ink-rgb),.08);margin-top:.5rem;overflow:hidden}'
+'.sbo-cubuk i{display:block;height:100%;background:var(--acc);border-radius:99px}'
+'.sbo-n{display:flex;gap:.4rem;flex-wrap:wrap;margin-top:.9rem}'
+'.sbo-r{position:relative;display:inline-flex;align-items:center;gap:.35rem;font-size:.8rem;letter-spacing:.02em;border:1px solid rgba(var(--ink-rgb),.14);border-radius:99px;padding:.3rem .6rem;color:var(--mut);background:transparent}'
+'.sbo-r.ac{color:var(--ink);border-color:var(--acc);background:rgba(var(--ink-rgb),.09)}'
+'.sbo-r i{font-style:normal;color:inherit}'
+'.sbo-gizli{font-size:.78rem;color:var(--mut);font-weight:300;line-height:1.6;margin-top:.9rem;padding-top:.75rem;border-top:1px solid rgba(var(--ink-rgb),.07)}'
+'.sbo-s{background:rgba(var(--ink-rgb),.032);border:1px solid rgba(var(--ink-rgb),.08);border-radius:16px;padding:1.1rem;margin:1.4rem 0;font-family:Inter,system-ui,sans-serif;color:var(--ink)}'
+'.sbo-s .sbo-q{margin-top:1rem}.sbo-s .sbo-q:first-of-type{margin-top:.6rem}'
+'.sbo-s .sbo-qb{font-size:.95rem;font-weight:500;color:var(--ink);margin:0 0 .55rem;max-width:74ch;line-height:1.5}'
+'.sbo-s .sbo-sec{display:flex;flex-direction:column;gap:.4rem;max-width:62ch}'
+'.sbo-s button{font:inherit;font-size:.9rem;font-weight:400;text-align:left;color:var(--ink);background:rgba(var(--ink-rgb),.04);border:1px solid rgba(var(--ink-rgb),.12);border-radius:12px;padding:.6rem .85rem;min-height:44px;cursor:pointer;line-height:1.4}'
+'.sbo-s button:hover:not([disabled]){background:rgba(var(--ink-rgb),.08);border-color:rgba(var(--ink-rgb),.22)}'
+'.sbo-s button[disabled]{cursor:default}'
+'.sbo-s button.d{border-color:var(--mut);background:rgba(var(--mut-rgb),.14)}'
+'.sbo-s button.y{border-color:var(--acc);background:rgba(var(--ink-rgb),.14)}'
+'.sbo-s .sbo-nd{font-size:.84rem;font-weight:300;color:var(--mut);line-height:1.6;margin:.55rem 0 0;max-width:70ch;border-left:2px solid rgba(var(--ink-rgb),.14);padding-left:.8rem}'
+'.sbo-s .sbo-nd b{color:var(--ink);font-weight:500}'
+'.sbo-s .sbo-nd.d{border-left-color:var(--mut)}.sbo-s .sbo-nd.y{border-left-color:var(--acc)}'
+'.sbo-s .sbo-son{font-size:.86rem;color:var(--ink);font-weight:500;margin-top:1rem;padding-top:.8rem;border-top:1px solid rgba(var(--ink-rgb),.08)}'
+'.sbo :focus-visible,.sbo-s :focus-visible{outline:2px solid var(--acc);outline-offset:2px;border-radius:8px}'
...
function ilerlemeCiz(el){
 ...
 +'<circle cx="37" cy="37" r="'+r+'" fill="none" stroke="rgba(var(--ink-rgb),.09)" stroke-width="6"/>'
 +'<circle cx="37" cy="37" r="'+r+'" fill="none" stroke="var(--acc)" stroke-width="6" stroke-linecap="round"'
