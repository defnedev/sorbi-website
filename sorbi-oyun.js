...
+'.sbo-r.ac{color:#F2EFE9;border-color:#E3A692;background:rgba(242,239,233,.09)}'
...
+'.sbo-s button.d{border-color:#A5A3AE;background:rgba(127,179,168,.14)}'
+'.sbo-s button.y{border-color:#E3A692;background:rgba(242,239,233,.14)}'
...
+'.sbo-s .sbo-nd.d{border-left-color:#A5A3AE}.sbo-s .sbo-nd.y{border-left-color:#E3A692}'
