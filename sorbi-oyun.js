...
var CSS='.sbo{background:rgba(var(--ink-rgb),.07);border:1px solid rgba(var(--ink-rgb),.14);border-radius:16px;padding:1.1rem;margin:1.4rem 0;font-family:Inter,system-ui,sans-serif;color:var(--ink)}'
...
+'.sbo-cubuk{height:6px;border-radius:99px;background:rgba(var(--ink-rgb),.14);margin-top:.5rem;overflow:hidden}'
...
+'.sbo-r.ac{color:var(--ink);border-color:var(--acc);background:rgba(var(--ink-rgb),.16)}'
+'.sbo-r i{font-style:normal;color:inherit}'
+'.sbo-gizli{font-size:.78rem;color:var(--mut);font-weight:300;line-height:1.6;margin-top:.9rem;padding-top:.75rem;border-top:1px solid rgba(var(--ink-rgb),.13)}'
+'.sbo-s{background:rgba(var(--ink-rgb),.07);border:1px solid rgba(var(--ink-rgb),.14);border-radius:16px;padding:1.1rem;margin:1.4rem 0;font-family:Inter,system-ui,sans-serif;color:var(--ink)}'
...
+'.sbo-s button{font:inherit;font-size:.9rem;font-weight:400;text-align:left;color:var(--ink);background:rgba(var(--ink-rgb),.08);border:1px solid rgba(var(--ink-rgb),.12);border-radius:12px;padding:.6rem .85rem;min-height:44px;cursor:pointer;line-height:1.4}'
+'.sbo-s button:hover:not([disabled]){background:rgba(var(--ink-rgb),.14);border-color:rgba(var(--ink-rgb),.22)}'
...
+'.sbo-s .sbo-son{font-size:.86rem;color:var(--ink);font-weight:500;margin-top:1rem;padding-top:.8rem;border-top:1px solid rgba(var(--ink-rgb),.14)}'
...
function ilerlemeCiz(el){
 ...
 +'<circle cx="37" cy="37" r="'+r+'" fill="none" stroke="rgba(var(--ink-rgb),.16)" stroke-width="6"/>'
