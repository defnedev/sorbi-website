...
' border:1px solid rgba(242,239,233,.35);border-radius:99px;padding:.5rem 1rem;cursor:pointer;',
' backdrop-filter:blur(12px);box-shadow:0 8px 28px rgba(0,0,0,.4);transition:.16s}',
'.gb-ac:hover{border-color:rgba(242,239,233,.7);color:#F2EFE9}',
...
'.gb-kutu{width:100%;max-width:460px;background:#0B0810;border:1px solid rgba(255,255,255,.12);',
...
'.gb-kutu p.gb-ac2{font-size:.83rem;color:#A5A3AE;font-weight:300;margin:0 0 .9rem;line-height:1.55}',
'.gb-tur{display:flex;gap:.35rem;margin-bottom:.7rem;flex-wrap:wrap}',
'.gb-tur button{flex:1 1 auto;font-family:inherit;font-size:.79rem;font-weight:500;color:#A5A3AE;',
...
'.gb-tur button.on{color:#0B0810;background:#E3A692;border-color:rgba(255,255,255,.14)}',
...
'.gb-kutu textarea:focus,.gb-kutu input:focus{border-color:rgba(242,239,233,.55)}',
'.gb-kutu ::placeholder{color:#868494}',
'.gb-alt{display:flex;gap:.5rem;align-items:center;margin-top:.7rem;flex-wrap:wrap}',
'.gb-gonder{font-family:inherit;font-size:.86rem;font-weight:600;color:#0B0810;background:#E3A692;',
...
'.gb-vazgec{font-family:inherit;font-size:.82rem;color:#A5A3AE;background:none;border:none;cursor:pointer;padding:.5rem}',
'.gb-vazgec:hover{color:#F2EFE9}',
'.gb-st{font-size:.8rem;color:#868494;min-height:1.1em;margin-left:auto}',
'.gb-st.iyi{color:#A5A3AE}.gb-st.hata{color:#E3A692}',
