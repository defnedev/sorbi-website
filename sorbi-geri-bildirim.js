...
'.gb-ac:hover{border-color:rgba(227,166,146,.7);color:#F2EFE9}',
...
'.gb-kutu{width:100%;max-width:460px;background:#151220;border:1px solid rgba(255,255,255,.12);',
...
'.gb-tur button.on{color:#151220;background:#E3A692;border-color:rgba(255,255,255,.14)}',
...
'.gb-gonder{font-family:inherit;font-size:.86rem;font-weight:600;color:#151220;background:#E3A692;',
